...
//
/*  Abel Huxtable(TheEccentricGenius), bears any responsibility for issues that are created
                                       due to modifications to this variants file.             */
//                                                                                    *INDENT-OFF*
/*
####  ####   ###  ####  #   # ##### #   #  ###      ##### #   # #   #        #  #   #
#   # #   # #   # #   # #   #   #   ##  # #   #       #   ##  # #  #       # #  #   #
...
#   #    #    #   #     ####  #   #     ####  ###      ###  #  #  #
===================================     ----------     #
Variant Definition file for Produino INK 4u            #

Also I've moved the LED_BUILTIN to PC2/13 
...
/* The pinout is messy due to, backwards compatible with UNO R1,R2,R3,R4. */
#define PIN_PA0 (1)
#define PIN_PA1 (0)
#define PIN_PA2 (2)
#define PIN_PA3 (3)
...
#define PIN_PC2 (13)
#define PIN_PC3 (10)
#define PIN_PD0 (14) /* On DB28, this isn't a pin - there, everything else NOT_A_PIN's pin 12 but we can add 3 to it to get PIN_PD3. */
#define PIN_PD1 (15)
#define PIN_PD2 (16)
#define PIN_PD3 (17)
#define PIN_PD4 (18)
...
const uint8_t digital_pin_to_port[] = {
  ...
  PD, //  9 PD7/AIN7/AREF
  PC, // 10 PC3/TCA0 PWM
  PC, // 11 PC0/USART1_Tx/TCA0 PWM
  PC, // 12 PC1/USART1_Rx/TCA0 PWM
  PC, // 13 PC2/TCA0 PWM/LED_BUILTIN
  PD, // 14 PD0/AIN0 - bit position and bit mask aren't defined if the pin doesn't exist, but we sometimes need to get port since it is the zero-pin.
  PD, // 15 PD1/AIN1
  PD, // 16 PD2/AIN2
  PD, // 17 PD3/AIN3/LED_BUILTIN
  PD, // 18 PD4/AIN4
  PD, // 19 PD5/AIN5
...
const uint8_t digital_pin_to_bit_position[] = { // *INDENT-OFF*
  ...
  PIN6_bp, //  8 PD6/AIN6
  PIN7_bp, //  9 PD7/AIN7/AREF
  PIN3_bp, // 10 PC3
  PIN0_bp, // 11 PC0/USART1_Tx
  PIN1_bp, // 12 PC1/USART1_Rx
  PIN2_bp, // 13 PC2/LED_BUILTIN
  #ifndef MVIO
    PIN0_bp, // 12 PD0/AIN0
  #else
    NOT_A_PIN,
...
const uint8_t digital_pin_to_bit_mask[] = {
  ...
  PIN6_bm, //  8 PD6/AIN6
  PIN7_bm, //  9 PD7/AIN7/AREF
  PIN3_bm, // 10 PC3
  PIN0_bm, // 11 PC0/USART1_Tx
  PIN1_bm, // 12 PC1/USART1_Rx
  PIN2_bm, // 13 PC2/LED_BUILTIN
  #ifndef MVIO
    PIN0_bm, // 14 PD0/AIN0
  #else
    NOT_A_PIN,
...
const uint8_t digital_pin_to_timer[] = {
  NOT_ON_TIMER, //  0 PA1/USART0_Rx
  NOT_ON_TIMER, //  1 PA0/USART0_Tx/CLKIN
  TIMERB0,      //  2 PA2/SDA
  TIMERB1,      //  3 PA3/SCL
  ...
  DACOUT,       //  8 PD6/AIN6
  NOT_ON_TIMER, //  9 PD7/AIN7/AREF
  NOT_ON_TIMER, // 10 PC3
  TIMERB2,      // 11 PC0/USART1_Tx
  NOT_ON_TIMER, // 12 PC1/USART1_Rx
  NOT_ON_TIMER, // 13 PC2/LED_BUILTIN
  NOT_ON_TIMER, // 14 (NOT A PIN on DB, DD)
